...
from strategies.prod.eurusd_buy import data, render_predictions
...
model.compile(loss=tf.keras.losses.MeanSquaredError(), optimizer=keras.optimizers.Adam(learning_rate=1e-5))
...
model.save('/usr/proj/trd/models/exp/dense/1/')

render_predictions.render_predictions()